  ...
  return (
    <div
      className={clsx(
        ...
        "before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-gold/5 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 before:pointer-events-none",
  ...
  return (
    <div
      className={clsx(
        ...
        "backdrop-blur-sm",
        "transition-all duration-300 ease-out",
        "before:absolute before:inset-0 before:rounded-2xl before:bg-gradient-to-br before:from-gold/10 before:via-transparent before:to-amber-glow before:opacity-60 before:pointer-events-none",
        "after:absolute after:inset-[1px] after:rounded-[15px] after:bg-gradient-to-br after:from-white/80 after:to-cream/60 after:backdrop-blur-sm after:pointer-events-none",
